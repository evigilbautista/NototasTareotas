...
const val DATABASE_NAME = "NotesDatabase"
    ...
    fun List<Note>?.orPlaceHolderList(): List<Note> {
        fun placeHolderList(): List<Note> {
            return listOf(Note(id = 0, title = "No Notas encontradas", note = "Por favor crea una nota.", dateUpdated = ""))
        }
    ...
    val noteDetailPlaceHolder = Note(note = "No se encuentran detalles de la nota", id = 0, title = "No se encuentra detalles de la nota")
}